function checkURL() {
  ...
  if (!url) {
    result.innerText = "⚠️ Please enter a URL first!";
  ...
  if (!isValidUrl) {
    result.innerText = "⚠️ Please enter a valid URL (start with http or https)";
    result.style.color = "orange";
    return;
  }
  ...
  fetch("http://127.0.0.1:5000/predict", {
    ...
    .catch(() => {
      result.innerText = "⚠️ Server error. Please try again.";
      result.style.color = "orange";
    });
}
